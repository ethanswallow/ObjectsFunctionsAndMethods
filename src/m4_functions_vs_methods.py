...
def try_methods_and_functions():
    ...
    adam.pen = rg.Pen('blue', 5)
    adam.backward(150)

    adam.speed = 1

    draw_many_squares(adam, 2, 100, 30)

    adam.speed = 5
    adam.pen.color = 'red'

    draw_many_squares(adam, 10, 50, 15)

    adam.speed = 100
    adam.pen.thickness = 35

    draw_many_squares(adam, 8, 300, 60)

    adam.pen = rg.Pen('black', 3)
    adam.backward(200)
