...
def two_circles():
    ...
    circle = rg.Circle(center_point, 105)
    circle.fill_color = 'blue'
    circle.attach_to(window)

    center2 = rg.Point(200, 400)
...
def circle_and_rectangle():
    ...
    rect_start = rg.Point(400, 300)
    rect_end = rg.Point(650, 400)
    rectangle = rg.Rectangle(rect_start, rect_end)
    rectangle.fill_color = 'red'
    rectangle.attach_to(window)

    rect_center = rg.Point((rect_start.x + rect_end.x) / 2, (rect_start.y + rect_end.y) / 2)
...
def lines():
    ...
    end1 = rg.Point(400, 500)
    end2 = rg.Point(500, 400)
    start2 = rg.Point(700, 450)
